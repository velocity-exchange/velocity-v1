	...
	it('Reduce long position', async () => {
		...
		assert(
			velocityClient
				.getUserStats()
				.getAccount()
				.fees.totalFeePaid.eq(new BN(28801))
		);
	...
	it('Reverse long position', async () => {
		...
		assert(
			velocityClient
				.getUserStats()
				.getAccount()
				.fees.totalFeePaid.eq(new BN(48001))
		);
		console.log(
			velocityClient
				.getUserAccount()
		...
		assert.ok(
			velocityClient
				.getUserAccount()
				.perpPositions[0].quoteBreakEvenAmount.eq(new BN(23980800))
		);
		console.log(
			velocityClient
				.getUserAccount()
	...
	it('Close position', async () => {
		...
		assert(
			velocityClient
				.getUserStats()
				.getAccount()
				.fees.totalFeePaid.eq(new BN(57601))
		);
