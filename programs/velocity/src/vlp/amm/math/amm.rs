...
pub fn calculate_market_open_bids_asks(amm: &AMM) -> VelocityResult<(i128, i128)> {
...
pub fn calculate_terminal_reserves(amm: &AMM) -> VelocityResult<(u128, u128)> {
...
pub fn calculate_terminal_price_and_reserves(amm: &AMM) -> VelocityResult<(u64, u128, u128)> {
...
pub fn calculate_expiry_price(
    ...
    let net_user_cost_basis =
        calculate_net_user_cost_basis(quote_asset_amount, net_unsettled_funding_pnl)?;
    ...
    let best_expiry_price = -(net_user_cost_basis
