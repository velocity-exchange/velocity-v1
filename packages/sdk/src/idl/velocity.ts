        ...
        "fields": [
          ...
          },
          {
            ...
            "docs": [
              ...
              "`resolve_perp_bankruptcy` decrements it when the debt is discharged or",
              "the latch is cleared. While it is above zero the fee sweep withholds",
              "the whole `pending_if_fee`, not just `get_bankruptcy_if_floor()` — the",
              "sweep is permissionless, so a caller could otherwise drain the",
              "first-loss tranche between the latch and the resolution and push the",
              "loss onto the shared insurance fund or into socialization. The freeze",
              "is independent of open interest and of `bankruptcy_if_floor_pct`, both",
              "of which can be zero exactly when a bankruptcy is pending.",
              "",
