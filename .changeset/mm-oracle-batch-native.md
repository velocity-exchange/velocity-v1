...
skips an entry landing more than `MM_ORACLE_MAX_SOURCE_AGE_SLOTS` past it, so a late-landing
transaction cannot make an old observation read as fresh. The builder additionally rejects an empty
