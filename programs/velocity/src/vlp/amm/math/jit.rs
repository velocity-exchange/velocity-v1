...
pub fn calculate_jit_base_asset_amount(
    ...
    let (max_bids, max_asks) =
        crate::vlp::amm::math::amm::calculate_market_open_bids_asks(&market.amm)?;
    ...
    jit_base_asset_amount =
        standardize_base_asset_amount(jit_base_asset_amount, market.order_step_size)?;
...
pub fn calculate_amm_jit_liquidity(
    ...
    let amm_wants_to_jit_make = market
        .amm
        .amm_wants_to_jit_make(taker_direction, market.order_step_size)?;
