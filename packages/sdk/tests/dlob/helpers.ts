...
> {
	return {
		...
		insuranceFundRevenueReceivable: new BN(0),
		paddingFuture: Array(248).fill(0),
		name: [],
...
export const mockSpotMarkets: Array<SpotMarketAccount> = [
	{
		...
		ordersEnabled: true,
		paddingFormerSpotFeePool: Array(16).fill(0),
		insuranceFundRevenueReceivableScaled: new BN(0),
		perpMarketIfRevenueReceivable: new BN(0),
		revenueSettleAllowance: new BN(0),
		paddingFuture: Array(240).fill(0),
...
export const mockStateAccount: StateAccount = {
	...
	// 0 = unset, resolves to the 400ms baseline; nothing staged
	slotDurationMs: 0,
