...
The bundled cargo in older platform-tools cannot parse `edition2024` dependencies. Install the
pinned toolchain once with `cargo-build-sbf --install-only --tools-version v1.57`, then verify with
