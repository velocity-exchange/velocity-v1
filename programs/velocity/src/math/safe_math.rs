...
pub trait SafeMath: Sized {
    ...
    fn safe_sub(self, rhs: Self) -> VelocityResult<Self>;
    fn safe_mul(self, rhs: Self) -> VelocityResult<Self>;
    fn safe_div(self, rhs: Self) -> VelocityResult<Self>;
    fn safe_div_ceil(self, rhs: Self) -> VelocityResult<Self>;
}
...
macro_rules! checked_impl {
    ($t:ty) => {
        impl SafeMath for $t {
            #[track_caller]
            #[inline(always)]
            fn safe_add(self, v: $t) -> VelocityResult<$t> {
            ...
            #[track_caller]
            #[inline(always)]
            fn safe_sub(self, v: $t) -> VelocityResult<$t> {
            ...
            #[track_caller]
            #[inline(always)]
            fn safe_mul(self, v: $t) -> VelocityResult<$t> {
            ...
            #[track_caller]
            #[inline(always)]
            fn safe_div(self, v: $t) -> VelocityResult<$t> {
            ...
            #[track_caller]
            #[inline(always)]
            fn safe_div_ceil(self, v: $t) -> VelocityResult<$t> {
...
pub trait SafeDivFloor: Sized {
    ...
    fn safe_div_floor(self, rhs: Self) -> VelocityResult<Self>;
}
...
macro_rules! div_floor_impl {
    ($t:ty) => {
        impl SafeDivFloor for $t {
            #[track_caller]
            #[inline(always)]
            fn safe_div_floor(self, v: $t) -> VelocityResult<$t> {
