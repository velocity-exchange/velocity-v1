...
impl ScaleOrderParams {
    ...
    pub fn validate(&self, order_step_size: u64) -> VelocityResult<()> {
        validate!(
    ...
    pub fn calculate_price_distribution(&self) -> VelocityResult<Vec<u64>> {
    ...
    pub fn calculate_size_distribution(&self, order_step_size: u64) -> VelocityResult<Vec<u64>> {
    ...
    fn calculate_flat_sizes(&self, order_step_size: u64) -> VelocityResult<Vec<u64>> {
    ...
    pub fn expand_to_order_params(&self, order_step_size: u64) -> VelocityResult<Vec<OrderParams>> {
