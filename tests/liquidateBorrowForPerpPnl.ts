...
describe('liquidate borrow for perp pnl', () => {
	...
	before(async () => {
		...
		// await contextWrapper.fundKeypair(contextWrapper.provider.wallet, BigInt(101 * LAMPORTS_PER_SOL));
	...
	it('liquidate', async () => {
		await setFeedPriceNoProgram(contextWrapper, 50, solOracle, 10000);
