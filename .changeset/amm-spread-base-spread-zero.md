...
`calculateSpreadBN`, which does the actual work, was already faithful to the Rust — given the devnet state above it returns 111791 against the program's 111723 — so no spread math changed, only whether it gets called.
