...
impl IsolatedMarginCalculation {
    ...
    pub fn margin_shortage(&self) -> VelocityResult<u128> {
        Ok(self
...
impl MarginCalculation {
    pub fn new(context: MarginContext) -> Self {
        Self {
            ...
            all_spot_liability_oracles_valid: true,
    ...
    pub fn add_cross_margin_total_collateral(&mut self, total_collateral: i128) -> VelocityResult {
    ...
    pub fn add_spot_liability(&mut self) -> VelocityResult {
        self.num_spot_liabilities = self.num_spot_liabilities.safe_add(1)?;
        Ok(())
    }

    pub fn add_perp_liability(&mut self) -> VelocityResult {
        self.num_perp_liabilities = self.num_perp_liabilities.safe_add(1)?;
        Ok(())
    }

    #[cfg(feature = "velocity-rs")]
    pub fn add_spot_asset_value(&mut self, spot_asset_value: i128) -> VelocityResult {
        self.total_spot_asset_value = self.total_spot_asset_value.safe_add(spot_asset_value)?;
        Ok(())
    }

    #[cfg(feature = "velocity-rs")]
    pub fn add_spot_liability_value(&mut self, spot_liability_value: u128) -> VelocityResult {
    ...
    #[cfg(feature = "velocity-rs")]
    pub fn add_perp_liability_value(&mut self, perp_liability_value: u128) -> VelocityResult {
    ...
    #[cfg(feature = "velocity-rs")]
    pub fn add_perp_pnl(&mut self, perp_pnl: i128) -> VelocityResult {
    ...
    pub fn validate_num_spot_liabilities(&self) -> VelocityResult {
    ...
    pub fn get_num_of_liabilities(&self) -> VelocityResult<u8> {
        self.num_spot_liabilities
    ...
    #[inline(always)]
    pub fn meets_isolated_margin_requirement(&self, market_index: u16) -> VelocityResult<bool> {
        Ok(self
    ...
    pub fn tracked_market_margin_shortage(&self, margin_shortage: u128) -> VelocityResult<u128> {
    ...
    pub fn get_cross_free_collateral(&self) -> VelocityResult<u128> {
        self.total_collateral
    ...
    pub fn get_isolated_free_collateral(&self, market_index: u16) -> VelocityResult<u128> {
    ...
    pub fn get_isolated_margin_calculation(
        &self,
        market_index: u16,
    ) -> VelocityResult<&IsolatedMarginCalculation> {
