...
Adds error `CannotModifyBuilderOrder` (6365) to the IDL. No instruction/account-layout change; error codes are read from the IDL (no manual `types.ts` mirror).
