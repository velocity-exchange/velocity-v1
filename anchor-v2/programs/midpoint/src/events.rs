...
pub struct MidpointExecuteRecordV0 {
    ...
    /// from velocity's own fill record. No value turns on it either way.
    /// Velocity matches the balance-change user against its registry before it
    /// settles anything.
